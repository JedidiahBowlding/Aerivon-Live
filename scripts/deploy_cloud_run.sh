...
ENV_VARS=(
  ...
  "AERIVON_LIVE_MAX_OUTPUT_TOKENS=$AERIVON_LIVE_MAX_OUTPUT_TOKENS"
  # Model selection defaults (override as needed)
  "GEMINI_FALLBACK_MODEL=${GEMINI_FALLBACK_MODEL:-gemini-3.1-pro}"
  "AERIVON_UI_MODEL=${AERIVON_UI_MODEL:-gemini-3.1-pro}"
  "AERIVON_VERTEX_IMAGE_MODEL=${AERIVON_VERTEX_IMAGE_MODEL:-gemini-3.1-flash-image}"
)
